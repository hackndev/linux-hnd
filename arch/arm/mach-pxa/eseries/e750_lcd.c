...
#if 0
static struct platform_device e750_lcd_hook_device = {
	.name = "e750-lcd-hook",
	.dev = {
		.parent = &e750_fb_device.dev,
	},
	.id = -1,
};
#endif
...
static int e750_lcd_init (void) {
	...
	if((ret = platform_device_register(&e750_fb_device)))
		return ret;

//	platform_device_register(&e750_lcd_hook_device);

	return 0;
}

static void e750_lcd_exit (void)
{
	//FIXME - free the platform dev for the w100 (imageon)
}

module_init (e750_lcd_init);
module_exit (e750_lcd_exit);
