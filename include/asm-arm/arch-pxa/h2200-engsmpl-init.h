/*
 * Initial GPIO register setup for iPAQ 22xx engineering sample
 * include/asm-arm/arch-pxa/h2200-engsmpl-init.h
 */

#ifndef _H2200_INIT_H_
#define _H2200_INIT_H_
