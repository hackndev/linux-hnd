...
unsigned short *crc16_table = NULL;
...
int crc16_init(void)
{
	...
	if(crc16_table == NULL)
	{
		...
		if((crc16_table = (unsigned short *)kmalloc(64*1024, GFP_KERNEL)) == NULL)
			return -1;
...
EXPORT_SYMBOL(crc16_init);
module_init(crc16_init);
